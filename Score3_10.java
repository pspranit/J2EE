...
public class Score3_10 {
	public static void main(String[] args) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader("/home/kaldin/Downloads/reports/3score.json"));
		String line;
		...
		List<BundleComponent> bundleComponentsList = root.getBundleComponents().getBundleComponent();
		int bundleComponentsListLength = bundleComponentsList.size();
		System.out.println("============Type==========");
		for (int i = 0; i < bundleComponentsListLength; i++) {
			BundleComponent bundleComponentObj = bundleComponentsList.get(i);
			if (bundleComponentsList.get(i).getCreditScoreType() != null) {
				System.out.println("==================CreditScoreType===================");
				System.out.println("@ScoreName : " + bundleComponentObj.getCreditScoreType().getScoreName());
				System.out.println("@PopulationRank : " + bundleComponentObj.getCreditScoreType().getPopulationRank());
				System.out.println("@RiskScore : " + bundleComponentObj.getCreditScoreType().getRiskScore());
				...
				System.out
						.println("@$ : " + bundleComponentObj.getCreditScoreType().getSource().getInquiryDate().get$());
				if (bundleComponentObj.getCreditScoreType().getSource().getReference() != null)
					System.out.println(
							"@$ : " + bundleComponentObj.getCreditScoreType().getSource().getReference().get$());
				System.out.println("@$ : " + bundleComponentObj.getType().get$());
				System.out.println("=====================================");
				...
				for (int j = 0; j < birthsList.size(); j++) {
					...
					System.out.println("@$ : " + birthsList.get(j).getSource().getInquiryDate().get$());
					if (birthsList.get(j).getSource().getReference() != null)
						System.out.println("@$ : " + birthsList.get(j).getSource().getReference().get$());
				}
				...
				for (int k = 0; k < borrowerAddressesListLength; k++) {
					...
					System.out.println("@$ : " + borrowerAddress.getSource().getInquiryDate().get$());
					System.out.println("=================Reference====================");
					if (borrowerAddress.getSource().getReference() != null)
						System.out.println("@$ : " + borrowerAddress.getSource().getReference().get$());
				}
				...
				for (int n = 0; n < borrowerNameListLength; n++) {
					...
					System.out.println("=================InquiryDate====================");
					System.out.println("@$ : " + borrowerName.getSource().getInquiryDate().get$());
					System.out.println("=================Reference====================");
					if (borrowerName.getSource().getReference() != null)
						System.out.println("@$ : " + borrowerName.getSource().getReference().get$());
				}
				...
				for (int c = 0; c < creditScoreList.size(); c++) {
					...
					System.out.println("=================InquiryDate====================");
					System.out.println("@$ : " + creditScoreList.get(c).getSource().getInquiryDate().get$());
					System.out.println("=================Reference====================");
					if (creditScoreList.get(c).getSource().getReference() != null)
						System.out.println("@$ : " + creditScoreList.get(c).getSource().getReference().get$());
				}
				System.out.println("=================CreditStatement====================");
				CreditStatement creditStatement = trueLink.getBorrower().getCreditStatements();
				System.out.println("statement : " + creditStatement.getStatement());
				System.out.println("=================Source====================");
				System.out.println("@BorrowerKey : " + creditStatement.getSource().getBorrowerKey());
				System.out.println("=================Bureau====================");
				System.out.println("@Abbreviation : " + creditStatement.getSource().getBureau().getAbbreviation());
				System.out.println("@Description : " + creditStatement.getSource().getBureau().getDescription());
				System.out.println("@Rank  : " + creditStatement.getSource().getBureau().getRank());
				System.out.println("@Symbol : " + creditStatement.getSource().getBureau().getSymbol());
				System.out.println("=================InquiryDate====================");
				System.out.println("@$ : " + creditStatement.getSource().getInquiryDate().get$());
				System.out.println("=================Reference====================");
				if (creditStatement.getSource().getReference() != null)
					System.out.println("@$ : " + creditStatement.getSource().getReference().get$());
				StatementType statementType = creditStatement.getStatementType();
				if(statementType!=null) {
				System.out.println("@Abbreviation : " + statementType.getAbbreviation());
				System.out.println("@Description  : " + statementType.getDescription());
				System.out.println("@Rank : " + statementType.getRank());
				System.out.println("@Symbol : " + statementType.getSymbol());}
				System.out.println("*************************************************");
				...
				for (int p = 0; p < previousAddresseList.size(); p++) {
					...
					System.out.println("=================InquiryDate====================");
					System.out.println("@$ : " + previousAddresseList.get(p).getSource().getInquiryDate().get$());
					System.out.println("=================Reference====================");
					if (previousAddresseList.get(p).getSource().getReference() != null)
						System.out.println("@$ : " + previousAddresseList.get(p).getSource().getReference().get$());
				}
				if (bundleComponentsList.get(i).getTrueLinkCreditReportType().getBorrower()
					...
					if(trueLink.getInquiryPartition()!=null) {
